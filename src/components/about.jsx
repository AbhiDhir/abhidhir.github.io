        ...
        <div className="colorlib-narrow-content">
            ...
            <div className="col-md-12">
                ...
                <div className="col-md-12">
                    ...
                    <p>Currently I am a part of ACM (Association for Computation and Machinery) where I participate in coding challenges and workshops. I am also a part of ISSS (Information and Systems Security Society) which participates in CTFs and explores the realm of cybersecurity. </p>
                    </div>
                </div>
                </div>
            </div>
